...
#define G_VFS_DAEMON_SOCKET_PROTOCOL_REQUEST_CANCEL 1
#define G_VFS_DAEMON_SOCKET_PROTOCOL_REQUEST_SEEK_CUR 2
#define G_VFS_DAEMON_SOCKET_PROTOCOL_REQUEST_SEEK_SET 3
#define G_VFS_DAEMON_SOCKET_PROTOCOL_REQUEST_SEEK_END 4
